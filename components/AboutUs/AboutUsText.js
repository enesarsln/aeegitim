...
const AboutUsText = () => {
  return (
    <div className="container about-us-main-text">
      <div className="row">
        <div className="col-md-12 mb-4 about-us-title">
          <span className="top-title">Özgeçmişimiz</span>
          <h1>İşte Bizim Hikayemiz</h1>
        </div>
      </div>
