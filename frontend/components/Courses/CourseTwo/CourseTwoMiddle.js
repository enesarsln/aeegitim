        ...
        <div className="course-two-middle">
            <div className="course-two-middel-box course-two-middel-text">
                <p><span className="top-title">Kurs Hakkında</span> <br></br>
                    ...
                    Bu kursun amacı, implant destekli protezlerin uygulanmasında kendinize olan güveninizi artırmak ve hastalarınıza üstün kalitede tedavi etmenizi sağlamaktır.
            ...
            <div className="course-two-middel-box course-two-middel-img">
                ...
                <img src="/img/implant-protez/implant-protez-5.jpg" alt="Image" />
                <img src="/img/implant-protez/implant-protez-6.jpg" alt="Image" />
                <img src="/img/implant-protez/implant-protez-7.jpg" alt="Image" />
            </div>
        </div>
    )
}
